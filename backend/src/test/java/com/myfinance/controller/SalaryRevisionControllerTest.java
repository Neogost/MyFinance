...
class SalaryRevisionControllerTest {
    ...
    @BeforeEach
    void setUp() {
        revision2024 = new SalaryRevisionDto(1L, LocalDate.of(2024, 1, 1), 45000f, null, "Augmentation 2024");
        revision2025 = new SalaryRevisionDto(2L, LocalDate.of(2025, 1, 1), 47000f, null, "Augmentation 2025");
    }
    ...
    void create_corpsInvalide_retourne400() throws Exception {
        ...
        CreateSalaryRevisionRequest request = new CreateSalaryRevisionRequest(
                LocalDate.of(2025, 1, 1), -1f, null, null);
    ...
    void update_avecCorpsValide_retourne200() throws Exception {
        UpdateSalaryRevisionRequest request = new UpdateSalaryRevisionRequest(
                LocalDate.of(2025, 1, 1), 48000f, null, "Augmentation 2025 corrigée");
        SalaryRevisionDto updated = new SalaryRevisionDto(2L, LocalDate.of(2025, 1, 1), 48000f, null, "Augmentation 2025 corrigée");
    ...
    void update_retourne404_siRevisionIntrouvable() throws Exception {
        UpdateSalaryRevisionRequest request = new UpdateSalaryRevisionRequest(
                LocalDate.of(2025, 1, 1), 48000f, null, null);
