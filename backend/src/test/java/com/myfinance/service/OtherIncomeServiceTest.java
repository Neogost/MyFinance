...
class OtherIncomeServiceTest {
    ...
    void create_sauvegardeEtRetourneLDto() {
        CreateOtherIncomeRequest request = new CreateOtherIncomeRequest(
                OtherIncomeTypeEnum.DIVIDENDE, "Dividendes SCPI", 210.50f, LocalDate.of(2025, 1, 15), null, null, null);
    ...
    void update_modifieLeRevenu() {
        UpdateOtherIncomeRequest request = new UpdateOtherIncomeRequest(
                OtherIncomeTypeEnum.LOCATIF, "Loyer révisé", 780f, LocalDate.of(2025, 4, 1), null, null, null);
    ...
    void update_leve403_siAutreUtilisateurNonAdmin() {
        UpdateOtherIncomeRequest request = new UpdateOtherIncomeRequest(
                OtherIncomeTypeEnum.LOCATIF, "Loyer", 750f, LocalDate.of(2025, 3, 1), null, null, null);
    ...
    void update_autorisePourAdmin() {
        UpdateOtherIncomeRequest request = new UpdateOtherIncomeRequest(
                OtherIncomeTypeEnum.LOCATIF, "Loyer admin", 750f, LocalDate.of(2025, 3, 1), null, null, null);
