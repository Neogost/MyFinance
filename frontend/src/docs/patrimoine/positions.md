...
> ![Formulaire de position, Etape 1](/docs/patrimoine/position-form-step1.png) — Formulaire étape 1 : sélection de la catégorie et de l'enveloppe fiscale

> ![Formulaire de position, Etape 2](/docs/patrimoine/position-form-step2.png) — Formulaire étape 2 : détails selon la catégorie (ex : recherche d'instrument BOURSE par ISIN)
...
> ![Formulaire de position, Etape 2](/docs/patrimoine/instrument-search.png) — Recherche d'instrument avec résultats et option de création à la volée
...
> ![Page patrimoine - Mode Liste](/docs/patrimoine/patrimoine-page.png) — Page patrimoine complète avec le résumé par catégorie et les indicateurs globaux
...
> ![Page patrimoine - Mode Liste](/docs/patrimoine/position-card-immo.png) — Carte d'une position IMMO_PHYSIQUE avec le bloc rouge "Crédit lié" et la valeur nette calculée
...
> ![Formulaire de saisie des Objectifs](/docs/patrimoine/target.png) — Formulaire de saisie des objectis patrimoniaux