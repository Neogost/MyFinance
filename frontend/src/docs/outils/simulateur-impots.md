...
> 📷 `public/docs/outils/tax-simulator-form.png` — Interface du simulateur avec les sélecteurs de source salariale et de revenus complémentaires
...
> 📷 `public/docs/outils/tax-simulator-result.png` — Résultat de la simulation avec le détail par tranche et les indicateurs de taux
