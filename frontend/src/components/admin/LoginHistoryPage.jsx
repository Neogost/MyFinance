...
export default function LoginHistoryPage() {
  ...
  return (
    <div>
      ...
      {/* ── Filtres ── */}
      <form onSubmit={handleSearch} className="bg-white rounded-xl shadow-sm p-4 mb-4 flex flex-wrap gap-3 items-end">
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            className="px-3 py-2 border border-gray-300 rounded-lg text-sm outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 transition bg-white w-40"
          />
        </div>
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="bg-gray-50">
                ...
                <th className="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wide">Adresse IP</th>
                <th className="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wide">Échecs</th>
                <th className="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wide">User-Agent</th>
              </tr>
            </thead>
            <tbody>
