...
export const WIDGETS = {
  ...
  'upcoming-expenses': {
    ...
    section: 'revenues',
    defaultSize: { w: 4, h: 5, minW: 4, minH: 4 },
    defaultVisible: true,
  ...
  'safety-net': {
    ...
    section: 'revenues',
    defaultSize: { w: 4, h: 2, minW: 3, minH: 1 },
    defaultVisible: true,
  ...
  'salary-monthly': {
    ...
    section: 'revenues',
    defaultSize: { w: 12, h: 7, minW: 8, minH: 5 },
    defaultVisible: true,
  ...
  'patrimoine-evolution': {
    ...
    section: 'patrimoine',
    defaultSize: { w: 9, h: 6, minW: 6, minH: 4 },
    defaultVisible: true,
  ...
  'fire-projection': {
    ...
    section: 'patrimoine',
    defaultSize: { w: 3, h: 6, minW: 3, minH: 4 },
    defaultVisible: true,
  ...
  'objectives': {
    ...
    section: 'objectifs',
    defaultSize: { w: 9, h: 5, minW: 6, minH: 3 },
    defaultVisible: true,
