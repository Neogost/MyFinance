...
export default function FireProjectionWidget() {
  ...
  return (
    <div className="flex flex-col h-full space-y-4">
      ...
      {/* Titre */}
      <p className="text-xs text-violet-500 uppercase tracking-wide font-semibold">
      ...
      <div className="space-y-2 pt-1 border-t border-violet-100">
        <StatRow
          ...
          value={tauxEpargne != null ? `${tauxEpargne.toFixed(1)} %` : '—'}
